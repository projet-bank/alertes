...
// ── Données BCEAO 2025 — tableau réglementaire intégré ─
const BCEAO_DEFAULT_DATA = [
  {t:'États de synthèse périodiques du PCB révisé',a:'2024-12-01',dl:'2025-01-15',p:'Mensuelle',e:'COMPTA'},
  {t:'États de synthèse périodiques du PCB révisé',a:'2024-12-01',dl:'2025-01-15',p:'Trimestrielle',e:'COMPTA'},
  {t:'États de synthèse périodiques du PCB révisé',a:'2024-12-01',dl:'2025-01-15',p:'Annuelle',e:'COMPTA'},
  {t:'États de synthèse périodiques du PCB révisé (Bilan et compte de résultat sur base sociale)',a:'2024-12-01',dl:'2025-02-28',p:'Semestrielle',e:'COMPTA'},
  ...
  {t:'États de synthèse périodiques du PCB révisé',a:'2025-03-01',dl:'2025-04-15',p:'Trimestrielle',e:'COMPTA'},
  ...
  {t:'États de synthèse périodiques du PCB révisé',a:'2025-06-01',dl:'2025-07-15',p:'Trimestrielle',e:'COMPTA'},
  {t:'États de synthèse périodiques du PCB révisé (Bilan et compte de résultat sur base sociale)',a:'2025-06-01',dl:'2025-08-31',p:'Semestrielle',e:'COMPTA'},
  ...
  {t:'États de synthèse périodiques du PCB révisé',a:'2025-09-01',dl:'2025-10-15',p:'Trimestrielle',e:'COMPTA'},
  ...
  {t:'États de synthèse périodiques du PCB révisé',a:'2025-12-01',dl:'2026-01-15',p:'Trimestrielle',e:'COMPTA'},
  {t:'États de synthèse périodiques du PCB révisé',a:'2025-12-01',dl:'2026-01-15',p:'Annuelle',e:'COMPTA'},
  ...
  {t:'État de déclaration des expositions relatives aux emprunteurs souverains',a:'2024-12-01',dl:'2025-03-31',p:'Semestrielle',e:'RISQUE'},
  {t:'État de déclaration des expositions relatives aux emprunteurs souverains',a:'2025-06-01',dl:'2025-09-30',p:'Semestrielle',e:'RISQUE'},
  {t:'FODEP Infra-semestriel',a:'2024-12-31',dl:'2025-01-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'FODEP Infra-semestriel',a:'2024-12-31',dl:'2025-01-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  ...
  {t:'FODEP Infra-semestriel',a:'2025-03-31',dl:'2025-04-30',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  ...
  {t:'FODEP Infra-semestriel',a:'2025-06-30',dl:'2025-07-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  ...
  {t:'FODEP Infra-semestriel',a:'2025-09-30',dl:'2025-10-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'FODEP Infra-semestriel',a:'2025-09-30',dl:'2025-10-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  ...
  {t:'FODEP Infra-semestriel',a:'2025-12-31',dl:'2026-01-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2024-12-31',dl:'2025-01-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2024-12-31',dl:'2025-01-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-01-31',dl:'2025-02-28',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-02-28',dl:'2025-03-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-03-31',dl:'2025-04-30',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-03-31',dl:'2025-04-30',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-04-30',dl:'2025-05-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-05-31',dl:'2025-06-30',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-06-30',dl:'2025-07-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-06-30',dl:'2025-07-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-07-31',dl:'2025-08-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-08-31',dl:'2025-09-30',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-09-30',dl:'2025-10-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-09-30',dl:'2025-10-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-10-31',dl:'2025-11-30',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-11-30',dl:'2025-12-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-12-31',dl:'2026-01-31',p:'Mensuelle',e:'CONTRÔLE DE GESTION'},
  {t:'Dispositif provisoire de suivi de la liquidation (DEC 2062 et 2063)',a:'2025-12-31',dl:'2026-01-31',p:'Trimestrielle',e:'CONTRÔLE DE GESTION'},
  {t:'États financiers individuels annuels certifiés (documents de fin d\'exercice)',a:'2024-12-31',dl:'2025-06-30',p:'Annuelle',e:'CONTRÔLE DE GESTION'},
  {t:'États financiers individuels de fin de premier semestre certifiés sur base sociale',a:'2025-06-01',dl:'2025-08-31',p:'Semestrielle',e:'CONTRÔLE DE GESTION'},
  ...
  {t:'Reporting au Fonds de Garantie des Dépôts et de Résolution dans l\'UMOA (FGDR-UMOA)',a:'2024-12-31',dl:'2025-07-15',p:'Annuelle',e:'CONTRÔLE DE GESTION'},
  ...
  {t:'Rapport semestriel sur le contrôle interne approuvé par l\'organe délibérant',a:'2024-12-31',dl:'2025-02-28',p:'Semestrielle',e:'AUDIT'},
  {t:'Rapport semestriel sur le contrôle interne approuvé par l\'organe délibérant',a:'2025-06-30',dl:'2025-08-31',p:'Semestrielle',e:'AUDIT'},
  ...
  {t:'Rapport annuel sur le dispositif global de gestion des risques approuvé par l\'organe délibérant',a:'2024-12-31',dl:'2025-04-30',p:'Annuelle',e:'DRC'},
  {t:'Lettre de mission des Commissaires aux comptes',a:'2025-01-01',dl:'2026-01-31',p:'Annuelle',e:'D.FINANCIERE'},
  {t:'Plan préventif de redressement (Circ. n°001-2020/CB/C)',a:'2024-01-01',dl:'2025-01-15',p:'Annuelle',e:'D.FINANCIERE'},
  {t:'Liste des Dirigeants (Circ. n°02-2017/CB/C)',a:'2025-01-01',dl:'2025-01-05',p:'Semestrielle',e:'DJRC'},
  {t:'Liste des Dirigeants + canevas additionnels (administrateurs, dirigeants, CAC)',a:'2025-07-01',dl:'2025-07-05',p:'Semestrielle',e:'DJRC'},
  ...
  {t:'Annuaire des Établissements de Crédit',a:'2024-12-31',dl:'2025-01-15',p:'Annuelle',e:'DJRC'},
  {t:'Annuaire des Établissements de Crédit',a:'2025-12-31',dl:'2026-01-15',p:'Annuelle',e:'DJRC'},
  {t:'Dispositif de suivi du taux de bancarisation et de l\'accès aux services financiers',a:'2024-12-31',dl:'2025-01-15',p:'Trimestrielle',e:'MARKETING'},
  {t:'Dispositif de suivi du taux de bancarisation et de l\'accès aux services financiers',a:'2025-03-31',dl:'2025-04-15',p:'Trimestrielle',e:'MARKETING'},
  {t:'Dispositif de suivi du taux de bancarisation et de l\'accès aux services financiers',a:'2025-06-30',dl:'2025-07-15',p:'Trimestrielle',e:'MARKETING'},
  {t:'Dispositif de suivi du taux de bancarisation et de l\'accès aux services financiers',a:'2025-09-30',dl:'2025-10-15',p:'Trimestrielle',e:'MARKETING'},
  {t:'Dispositif de suivi du taux de bancarisation et de l\'accès aux services financiers',a:'2025-12-31',dl:'2026-01-15',p:'Trimestrielle',e:'MARKETING'},
  {t:'État de suivi du traitement des créances reportées (15 et 30 de chaque mois)',a:'—',dl:'—',p:'Bimensuelle',e:'ENGAGEMENTS'},
  {t:'État du relevé quotidien de la position extérieure des banques',a:'—',dl:'—',p:'Quotidienne',e:'TRESORERIE'},
  {t:'État de calcul des besoins courants et état MCCE',a:'—',dl:'—',p:'Quotidienne',e:'TRESORERIE'},
  {t:'État des variations prévisionnelles des facteurs autonomes de la liquidité bancaire',a:'—',dl:'—',p:'Hebdomadaire',e:'TRESORERIE'},
  {t:'État des opérations interbancaires',a:'—',dl:'—',p:'Hebdomadaire',e:'TRESORERIE'}
];
...
// Réinitialiser avec les données BCEAO par défaut
function resetToBceaoDefault(){
  if(!confirm('Remplacer toutes les données Excel par le tableau BCEAO 2025 intégré ?\nLes échéances manuelles seront conservées.'))return;
  csvData=[...BCEAO_DEFAULT_DATA];
  transmittedSet=new Set([...transmittedSet].filter(k=>customDL.some(d=>(d.t+'|'+d.dl)===k)));
  csvData.forEach(d=>{const dlD=pDate(d.dl);if(dlD&&dlD<TODAY)transmittedSet.add(d.t+'|'+d.dl);});
  buildData();updateKPIs();renderCurrentPage();renderCsvDataTable();
  saveToFirestore();saveTransmitted();
  showToast('✅','Tableau BCEAO 2025 chargé ('+csvData.length+' échéances)');
}
...
function downloadExcelTemplate() {
  ...
  const data=[
    ...
    ["FODEP Infra-semestriel","2025-03-31","2025-04-30","Trimestrielle","CONTRÔLE DE GESTION"]
  ];
  const ws=XLSX.utils.aoa_to_sheet(data);
  ws['!cols']=[{wch:45},{wch:15},{wch:15},{wch:18},{wch:25}];
...
function processCSV(text, filename) {
  ...
  if(iDeadline===-1){showCsvStatus('error','❌ Colonne "Date limite" introuvable.');return;}
  const parsed=[],skipped=[],autoTransmitted=[];
  for(let i=1;i<lines.length;i++){
    ...
    if(!dl||!pDate(dl)){skipped.push('Ligne '+(i+1)+' : date invalide');continue;}
    parsed.push({t,a:a||'—',dl,p,e});
    const dlDate=pDate(dl);
    if(dlDate&&dlDate<TODAY){transmittedSet.add(t+'|'+dl);autoTransmitted.push(t);}
  }
  ...
  if(autoTransmitted.length>0)msg+=`<br>🕐 <strong>${autoTransmitted.length}</strong> passé${autoTransmitted.length>1?'s':''} → <span class="transmitted-badge" style="font-size:11px">✅ Transmis</span> automatiquement`;
...
function renderCsvDataTable(){
  ...
  if(stats)stats.innerHTML=[{label:'Total',val:csvData.length,col:'var(--navy)'},{label:'🔴 Urgents',val:urgCount,col:'var(--red)'},{label:'🟡 Proches',val:warnCount,col:'var(--orange)'},{label:'🟢 À venir',val:okCount,col:'var(--green)'},{label:'⚫ Passés (auto-transmis)',val:pastCount,col:'var(--gray)'}].map(s=>`<div class="csv-stat-pill" style="border-left:3px solid ${s.col}"><span class="csv-stat-val" style="color:${s.col}">${s.val}</span><span class="csv-stat-lbl">${s.label}</span></div>`).join('');
  tbody.innerHTML=csvData.slice(0,50).map(d=>{const key=d.t+'|'+d.dl,dlD=pDate(d.dl),days=dUntil(dlD),st=getSt(days),isTrans=transmittedSet.has(key);return`<tr style="${isTrans?'opacity:0.55':''}"><td><span class="status-dot ${st}"></span>${isTrans?' <span style="font-size:10px;color:var(--green)">✅</span>':''}</td><td class="td-title">${d.t}</td><td><span class="entity-pill" style="color:${eC(d.e)};background:${eCb(d.e)}">${d.e}</span></td><td style="font-size:12px;color:var(--text3)">${d.p}</td><td style="font-family:'JetBrains Mono',monospace;font-size:12px">${fmtS(d.a)}</td><td style="font-family:'JetBrains Mono',monospace;font-size:12px;font-weight:600">${fmtS(d.dl)}</td><td><span class="badge ${st}">${dLabel(days,st)}</span></td></tr>`;}).join('')+(csvData.length>50?`<tr><td colspan="7" style="text-align:center;color:var(--text3);font-size:12px;padding:12px">… et ${csvData.length-50} autres</td></tr>`:'');
}
async function clearCsvData(){
  if(!confirm('Supprimer toutes les données Excel importées ?\nLes échéances manuelles seront conservées.'))return;
  csvData=[];transmittedSet=new Set([...transmittedSet].filter(k=>customDL.some(d=>(d.t+'|'+d.dl)===k)));
  buildData();updateKPIs();renderCurrentPage();renderCsvDataTable();
...
async function sendEmailAlerts(docs){
  ...
  initEmailJS();
  const lines=toSend.map(d=>(d.days<=settings.urgentDays?'🔴':'🟡')+' '+d.title+' | '+d.entity+' | '+fmtS(d.deadline)+' | '+dLabel(d.days,d.st)).join('\n');
  try{
...
// ── Données ───────────────────────────────────────────
function pDate(s){if(!s||s==='Quotidien'||s==='Hebdomadaire'||s==='—')return null;const d=new Date(s);d.setHours(0,0,0,0);return isNaN(d)?null:d;}
...
function buildData(){
  ...
  ALL=raw.map((d,i)=>{
    const dlD=pDate(d.dl),days=dUntil(dlD),key=d.t+'|'+d.dl,transmitted=transmittedSet.has(key);
...
async function markTransmittedById(docKey){
  transmittedSet.add(docKey);buildData();updateKPIs();renderCurrentPage();
  await saveTransmitted();notifications=notifications.filter(n=>n.docKey!==docKey);
  updateBellBadge();await saveNotifications();showToast('✅','Document marqué comme transmis');
}
function markTransmitted(){if(!selDL)return;markTransmittedById(selDL.key);document.getElementById('dm-transmitted-status').style.display='';document.getElementById('dm-btn-transmitted').style.display='none';}
function transmitBtn(d,small=false){
  ...
  return`<button class="btn-transmit${small?' btn-transmit-sm':''}" onclick="event.stopPropagation();markTransmittedById('${k}')" title="Marquer comme transmis">✅ Transmis</button>`;
}
...
function renderTable(){
  ...
  document.getElementById('tbl-body').innerHTML=ALL.length===0?`<tr><td colspan="8" style="text-align:center;padding:40px;color:var(--text3)">📂 Aucune donnée — Importez un Excel dans <strong>Paramètres</strong></td></tr>`:data.map(d=>`<tr onclick="openDetail(${d.id})" style="cursor:pointer${d.transmitted?';opacity:0.65':''}"><td><span class="status-dot ${d.st}"></span>${d.transmitted?' <span style="font-size:10px;color:var(--green)">✅</span>':''}</td><td class="td-title">${d.title}</td><td><span class="entity-pill" style="color:${eC(d.entity)};background:${eCb(d.entity)}">${d.entity}</span></td><td style="font-size:12px;color:var(--text3)">${d.period}</td><td style="font-family:'JetBrains Mono',monospace;font-size:12px">${fmtS(d.arrete)}</td><td style="font-family:'JetBrains Mono',monospace;font-size:12px;font-weight:600">${fmtS(d.deadline)}</td><td><span class="badge ${d.st}">${dLabel(d.days,d.st)}</span></td><td onclick="event.stopPropagation()">${transmitBtn(d,true)}</td></tr>`).join('');
}
...
function renderTimeline(){
  const MOIS=['Janvier','Février','Mars','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre'],months={};
  ...
  document.getElementById('timeline-wrap').innerHTML=ALL.length===0?'<div class="empty"><div class="e-ico">📂</div><h3>Aucune donnée importée</h3></div>':Object.keys(months).sort().map(k=>{const[y,m]=k.split('-'),items=months[k].sort((a,b)=>a.dlD-b.dlD);return`<div class="timeline-month"><div class="timeline-month-header">${MOIS[parseInt(m)]} ${y} <span style="font-size:12px;opacity:0.7">(${items.length})</span></div><table class="data-table"><thead><tr><th>Statut</th><th>Document</th><th>Entité</th><th>Date limite</th><th>Délai</th><th>Action</th></tr></thead><tbody>${items.map(d=>`<tr onclick="openDetail(${d.id})" style="cursor:pointer${d.transmitted?';opacity:0.65':''}"><td><span class="status-dot ${d.st}"></span></td><td class="td-title">${d.title}</td><td><span class="entity-pill" style="color:${eC(d.entity)};background:${eCb(d.entity)}">${d.entity}</span></td><td style="font-family:'JetBrains Mono',monospace;font-size:12px">${fmtS(d.deadline)}</td><td><span class="badge ${d.st}">${dLabel(d.days,d.st)}</span></td><td onclick="event.stopPropagation()">${transmitBtn(d,true)}</td></tr>`).join('')}</tbody></table></div>`;}).join('');
}
